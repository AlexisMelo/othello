...
\begin{document}
	...
	\begin{tad}
		...
		\begin{tadOperations}{Coups}
			...
			\tadOperation{AjouterCoup}{\tabUnParam{Coups x Coup}}{\tabUnParam{Coups}}
			\tadOperation{RetirerCoup}{\tabUnParam{Coups x Coup}}{\tabUnParam{Coups}}
			\tadOperation{NombreCoups}{\tabUnParam{Coups}}{\tabUnParam{Naturel}}
		\end{tadOperations}

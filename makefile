...
$(TESTDIR)/testAff : $(TESTDIR)/*.o $(SRCDIR)/*.o # $(TESTDIR)/testLigne.o $(TESTDIR)/testColonne.o $(TESTDIR)/testCouleur.o $(TESTDIR)/testPlateau.o $(TESTDIR)/testAffichage.o $(SRCDIR)/Colonne.o $(SRCDIR)/Coup.o $(SRCDIR)/Position.o $(SRCDIR)/Ligne.o $(SRCDIR)/Couleur.o $(SRCDIR)/Plateau.o $(SRCDIR)/Direction.o $(SRCDIR)/AfficherPlateau.o $(SRCDIR)/InitialiserPlateau.o $(SRCDIR)/JouerCoup.o
		$(CC) -o $(TESTDIR)/testAff $^ -lcunit $(CFLAGS) -I$(TESTDIR)

$(TESTDIR)/testTypes :  $(TESTDIR)/testLigne.o $(TESTDIR)/testColonne.o $(TESTDIR)/testCouleur.o $(TESTDIR)/testParcourirLesDirections.o $(TESTDIR)/testParcourirUneDirection.o $(TESTDIR)/testPlateau.o $(TESTDIR)/TypesTests.o $(TESTDIR)/testRechercheDesCoups.o $(TESTDIR)/testCoups.o $(TESTDIR)/testCoup.o $(SRCDIR)/AfficherPlateau.o $(SRCDIR)/CalculerPoint.o $(SRCDIR)/Colonne.o $(SRCDIR)/Couleur.o $(SRCDIR)/Coup.o $(SRCDIR)/CoupCollection.o $(SRCDIR)/Coups.o $(SRCDIR)/Direction.o $(SRCDIR)/InitialiserPlateau.o $(SRCDIR)/JouerCoup.o $(SRCDIR)/Ligne.o $(SRCDIR)/ListeChainee.o $(SRCDIR)/Position.o $(SRCDIR)/Parcourir_Direction.o $(SRCDIR)/Plateau.o $(SRCDIR)/Recherche_Coup.o 

 ...
 * lance le jeu.
 *
 * \example : PARTIE_FaireUnePartie(AfficherResultat,AfficherPlateau,AfficherCoup, AfficherSaisieCoup, j1,j2)
 *
 ...
 * \param AfficherCoup Pointeur de fonction pour afficher le coup qui viens d'être joué
 * \param AfficherSaisieCoup Pointeur de fonction pour afficher la demande de saisie d'un coup

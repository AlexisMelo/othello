...
bool POSITION_EstEgalPosition(Position position1, Position position2) {
    return COLONNE_SontEgalesColonnes(POSITION_ObtenirColonne(position1), POSITION_ObtenirColonne(position2)) && LIGNE_EstEgalLigne(POSITION_ObtenirLigne(position1), POSITION_ObtenirLigne(position2));
}

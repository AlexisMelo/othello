...
\begin{tad}
	...
	\begin{tadOperations}{Plateau}
		...
		\tadOperationAvecPreconditions{PLATEAU_JouerCoup}{\tadUnParam{Plateau x Coup}}{\tadUnParam{Plateau}}
	...
	\end{tadOperations}
	\begin{tadAxiomes}
		\tadAxiome{ObtenirCouleur(PLATEAU_JouerCoup(Plateau,Coup(Position,Couleur)), Position) = Couleur}
	\end{tadAxiomes}
	\begin{tadPreconditions}{Plateau}
		\tadPrecondition{PLATEAU_JouerCoup}{EstPositionValide(Plateau,ObtenirPosition(Coup))}
	\end{tadPreconditions}
\end{tad}
